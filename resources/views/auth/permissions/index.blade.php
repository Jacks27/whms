...
@section('content-header', 'Permissions list')
                            ...
                            <div class="col-md-4">
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{route('permissions.filter',['name' => 'role'])}}">Role</a>
                                    <a class="dropdown-item" href="{{route('permissions.filter',['name' => 'permission'])}}">Permissions</a>


                                  </div>
                                </div>
                                @if(Request::has('name'))
                                <a href="{{route('permissions.index')}}" title="">Clear Filter</a>
                                @endif()
                            </div>
                        </div>
                                ...
                                <div class="table-responsive" data-pattern="priority-columns">
                                    <table id="tech-companies-1" class="table table-striped mb-0">
                                        ...
                                        <tr>
                                            <th>{{$p->id}}</th>
                                            <td>{{$p->name}}</td>
                                            <td><a href="{{url('/permissions'.$p->id.'/edit')}}" class="">Edit</a></td>
